      ...
      >
        ...
        <div className={homeStyles.contentContainer}>
          ...
          <p className={styles.techList}>
            <strong>NodeJS:</strong> NestJS, Sequelize, TypeORM, Socket.io, Unit
            Tests.
            <br />
            <strong>Databases:</strong> PostgreSQL, MongoDB, Oracle, DynamoDB,
            MariaDB.
            <br />
            {!showMore && (
            ...
            {showMore && (
              <>
                ...
                Pytorch, Matplotlib, Seaborn, Yolo, Rasa/Rasa Enterprise, Data
                Analysis, Data Wrangling/Preparation, Dataset augmentation.
                <br />
          ...
          {showMore && (
            <p className={styles.aboutDescription}>
              ...
              people's lives, and I saw programming as a way to turn my ideas
              into reality.
            </p>
          )}
          {showMore && (
            <p className={styles.aboutDescription}>
              My goal is to work with artificial intelligence. While I'm not,
              I'm working on my skills and learning new things almost every day.
              Since AI is so extensive, I decided to create this website so I
              can document my journey and share my knowledge with others.
            </p>
          )}
